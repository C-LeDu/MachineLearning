...
experiment_name = "CIFAR10_CONVNET_2_DENSE_MAXPOL22_RELU_MAXPOOL_1_2_LR_1"
...
conv_model.add(Dense(65, activation='tanh'))
conv_model.add(Dense(10, activation='sigmoid'))

conv_model.compile(sgd(lr=1, ), mse, metrics=[categorical_accuracy])

conv_model.fit(x_train, y_train, batch_size=4000, epochs=2000, verbose=1, callbacks=[tb_callback],
