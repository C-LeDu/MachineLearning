...
experiment_name = "CIFAR10_CONVNET_2_DENSE_SOFTPLUS_MAXPOOL_1_2_LR_0.5"
...
conv_model.fit(x_train, y_train, batch_size=4000, epochs=20000, verbose=1, callbacks=[tb_callback],
